                ...
                <form className="row" onSubmit={(e) => verificarDatos(e, datosGuardados)}>
                    ...
                    <div id="formulario-AgregarUsuario">
                        ...
                        <div className="form-check form-check-inline">
                            ...
                            <input className="form-check-input" type="radio" id="radioButton" value="true" title="Cuenta para administrador" onChange={handleInputChange} name="es_admin" />
                            <p id="pAdministrador-AgregarCuenta" for="inlineRadio1">Administrador</p>

                        </div>
                        <div className="form-check form-check-inline">

                            <input className="form-check-input" type="radio" id="radioButton" value="false" title="Cuenta para usuario" onChange={handleInputChange} name="es_admin" />
                        ...
                        <div id="cajaBotones-AgregarCuenta">
                            ...
                            <div id="cajaRegresar-AgregarCuenta">
                                ...
                                <button id="botonRegresar-AgregarCuenta" type="button" className="btn btn-primary" onClick={(e) => estadoInicial(e)} title="Regresar a la plataforma">Regresar</button>

                            </div>


                            <div id="cajaEnviar-AgregarCuenta">
                                <button id="botonEnviar-AgregarCuenta" type="submit" className="btn btn-primary" title="Crear nuevo usuario" data-bs-toggle="modal" data-bs-target="#modalMensaje-AgregarUsuario">Enviar</button>
                            </div>
