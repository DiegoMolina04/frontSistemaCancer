...
function Preguntas() {
    ...
    const { datosTablaModificar, setDatosTablaModificar } = useContext(UserContext);//guardarID, setGuardarID
    ...
    const { listarElementos, componenteListarPreguntas, componenteListarSintomas, componenteMostrarMensaje, componenteAgregarUsuario, modificarPregunta, cargarSintomasModificar, eliminarUsuario, handleChange, userinfo, reiniciarModal} = usePreguntas();
    ...
    /*const listarPreguntas = async (event) => {
        ...
        event.preventDefault();
        //console.log("Entre al listarPreguntas");
        setCodigo("listar");
    ...
    return (
        ...
        <div id="fondo-AdministrarPreguntas">
            ...
            <form className="row" onSubmit={(e) => modificarPregunta(e, datosOriginales, datosGuardados, datosTablaModificar, guardarID)}>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div className="input-group">
                                    <div className="input-group-text" id="btnGroupAddon"><i class="fas fa-font"></i></div> {/*editarPregunta.symptoms.map(elemento => (elemento.sintoma))*/}{/*value={cargarSintomasModificar()}*/}{/*JSON.stringify(datosGuardados.symptoms)*/}{/*value={datosTablaModificar} onChange={handleCheckboxChange}*/}
