...
const useAgregarPregunta = () => {
    ...
    return { cargarSintomas, enviarDatos, componenteListarSintomas, componenteMostrarMensaje, handleChange, reiniciarDatos };//verificarDatos, mostrarMensaje, estadoInicial
};
