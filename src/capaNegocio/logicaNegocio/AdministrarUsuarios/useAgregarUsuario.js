...
const useAgregarUsuario = () => {
    ...
    function verificarCodigo(codigo) {
        ...
        switch (codigo) {
            ...
            case 404:
                setComponenteMostrarMensaje(<MostrarMensaje mensaje={"El correo/contraseña ingresado ya está registrado."} />);
                break;
            ...
            case 500:
                setComponenteMostrarMensaje(<MostrarMensaje mensaje={"La cédula ingresada ya está registrada."} />);
                break;
